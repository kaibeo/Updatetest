...
local IndexUIColor = {
    ...
    ["Dropdown Selected Color"] = Color3.fromRGB(180, 140, 40), -- nền vàng nâu nhẹ
    ...
    ["Slider Line Color"] = Color3.fromRGB(120, 90, 25), -- vàng đậm làm nền
    ["Slider Highlight Color"] = Color3.fromRGB(255, 215, 0), -- vàng sáng khi fill
...
function Library.CreateMain(Setting)
	...
	local colorB = tostring(Library_Function.Getcolor(cache.UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
	TextLabelMain.Text = "<font color=\"rgb("..color..")\">ZMatrix Hub </font> " .."- Evade"
