...
local v15 = v14:CreateWindow({
    Title = "Ziner Hub [FREE SCRIPT VESION]",
    SubTitle = "ziner team",
    TabWidth = 160,
    Theme = "Drak",
    Acrylic = false,
...
v16.Home:AddButton({
    Title = "Discord",
    Description = "thông báo update script",
    Callback = function()
        setclipboard("https://discord.gg/zM4cRG2Nvv");
    end
});
...
G2L["2"]["TextSize"] = 21.000;

G2L["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)

G2L["2"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansBold.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);

G2L["2"]["Size"] = UDim2.new(0, 53, 0, 53);

G2L["2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);

G2L["2"]["Text"] = [[OFF]];

G2L["2"]["Position"] = UDim2.new(0.07075, 0, 0.20891, 0);
...
G2L["2"].MouseButton1Click:Connect(function()
   ...
   game:GetService("VirtualInputManager"):SendKeyEvent(true, "RightShift",false,game)
    ...
    G2L["2"].Text = toggleState and "OFF" or "ON"

    local anchor = game.CoreGui:FindFirstChild("Anchor")
