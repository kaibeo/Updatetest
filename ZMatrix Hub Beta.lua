...
wind:SetTheme("Dark")
local page1 = Window:Tab({Title = "Tab Information",Icon = "info"})
local page2 = Window:Tab({Title = "Tab Shop",Icon = "shopping-basket"})
local page3 = Window:Tab({Title = "Tab Setting Farm",Icon = "cog"})
local page4 = Window:Tab({Title = "Tab Farming",Icon = "sword"})
local page5 = Window:Tab({Title = "Tab Other Farm",Icon = "swords"})
local mltab = Window:Tab({Title = "Tab Auto Melee",Icon = "hand-fist"})
local page6 = Window:Tab({Title = "Tab Local Player",Icon = "person-standing"})
local pvp = Window:Tab({Title = "Tab PVP",Icon = "speech"})
local raid = Window:Tab({Title = "Tab Raid",Icon = "heart"})
local page11 = Window:Tab({Title = "Tab Updrage Race",Icon = "dna"})
local page12 = Window:Tab({Title = "Tab Dungeon",Icon = "rabbit"})
local page13 = Window:Tab({Title = "Tab Traveling",Icon = "plane"})
local page7 = Window:Tab({Title = "Tab Sea Event",Icon = "fish"})
local page8 = Window:Tab({Title = "Tab Volcano",Icon = "mountain-snow"})  -- Xóa , Locked = true
local page9 = Window:Tab({Title = "Tab Dojo Quest",Icon = "ribbon"})     -- Xóa , Locked = true
local page10 = Window:Tab({Title = "Tab Leviathan",Icon = "sparkles"})   -- Xóa , Locked = true
page2:Select()
...
local function CreateUI()
    ...
    Title.Text = "ZMatrix Hub > AUTHENTICATION"
